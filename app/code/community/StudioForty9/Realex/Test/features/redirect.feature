Feature: Redirect Method
   ...
   Scenario Outline: Customer makes a purchase with American Express
      ...
      Then I should see "You will be redirected to the Realex website once you place your order."
      And I should see "Pay with American Express"
      And I should see "Pay with Other Credit/Debit Card"
      When I choose "Pay with American Express"

      And I press "Continue"
      And I wait "5" Seconds
      And I press "Place Order"
      And I wait "5" Seconds
      Then I should be on "/realex/redirect"
      When I wait "5" Seconds
      Then I should be on "https://epage.payandshop.com/epage.cgi"

      When I select <cc_type> from "Credit Card Type"
	...
	Scenario Outline: Customer makes a purchase with main CC Type
		  Given the Realex configuration for "amex_account" is ""
	      ...
	      And I choose Realex as the Payment Method
	      Then I should see "You will be redirected to the Realex website once you place your order."
	      And I should not see "Pay with American Express"
	      And I should not see "Pay with Other Credit/Debit Card"
	      ...
	      And the status of the newly created order should be "Pending"
